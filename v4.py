...
iterations_label = ctk.CTkLabel(kmeans_frame, text="Benötigte Iterationen: ")
...
compute_button = ctk.CTkButton(ils_frame, text="Compute", width=30, command=ILS, font=label_font, fg_color=button_color)
